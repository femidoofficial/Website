...
const policyHtml = `<div class="policy-container">
        ...
        <p>At SheGo, we value your privacy and are committed to protecting your personal information. This Privacy
            ...
            our website, mobile application, or any of our services.</p>

        <p>This Policy is intended to help you understand what information we collect, why we collect it, how we use it,

            the choices available to you regarding your personal information, and the measures we take to protect your
        ...
        <p>SheGo is operated by [MLOCK INNOVATIONS LLP] (&quot;SheGo&quot;, &quot;Company&quot;, &quot;we&quot;,
            ...
            office at [139, Uday Nagar, Indore Kanadia Road, Indore, Indore, Madhya Pradesh, India, 452016].</p>

        <p>For any questions, concerns, or requests relating to this Privacy Policy or your personal data, you may
        ...
        <p>Ride booking, scheduling, and trip management;</p>

        <p>Payment processing and billing services;</p>

        <p>Customer support and grievance redressal;</p>

        <p>User account creation and management;</p>

        <p>Safety and verification features;</p>
        ...
        <p>By accessing, registering for, or using the SheGo website, mobile application, or any of our services, you
            ...
            disclosure, and protection of your personal information in accordance with this Privacy Policy.</p>

        <p>Where required under applicable law, we will obtain your consent before collecting or processing your

            personal data. You may withdraw your consent at any time by contacting us or through the options available

            within our services, subject to legal or contractual obligations and the consequences of such withdrawal.
        ...
        <p>SheGo may revise or update this Privacy Policy from time to time to reflect changes in our services, legal
            ...
            notify users through appropriate means, such as by posting the updated Privacy Policy on our website or
        ...
        <p>Your continued access to or use of SheGo&#x27;s services after the updated Privacy Policy becomes effective
            ...
            you should discontinue using our services and may request the deletion of your account, subject to
        ...
        <p>You further acknowledge that certain features or services may require the collection of specific categories

            of personal information to enable the safe, secure, and efficient provision of our services. If you choose

            not to provide information that is necessary for a particular service, we may be unable to provide or
        ...
        <p>&quot;Personal Data&quot; means any data about an individual who is identifiable by or in relation to such
            ...
            data, whether directly or indirectly, including information that can identify, contact, or locate an
        ...
        <p>&quot;Sensitive Personal Data&quot; refers to personal information that requires a higher level of protection
            ...
            under applicable law. To the extent permitted or required by law, this may include financial information,

            government-issued identification details, biometric information, health-related information, authentication
        ...
        <p>&quot;Processing&quot; means any operation or set of operations performed on Personal Data, whether by
            ...
            automated or manual means, including the collection, recording, organization, storage, adaptation,

            retrieval, consultation, use, disclosure, sharing, transmission, alignment, combination, restriction,
        ...
        <p>To access or use the SheGo Platform and its Services, you must be legally competent to enter into a binding
            ...
            age and legal capacity requirements prescribed by the laws of your jurisdiction.</p>

        <p>Individuals below the age of eighteen (18) years, or those who are otherwise not legally competent to
        ...
        <p>When you register for an account, book or provide rides, communicate with us, or otherwise use our Services,
            ...
            you may provide personal information including your name, mobile number, email address, date of birth,

            gender, profile photograph, postal address, and any other information necessary for creating and managing

            your account or delivering our Services.</p>

        <p>You represent and warrant that all information you provide is accurate, complete, and up to date, and you
        ...
        <p>Username or profile information;</p>

        <p>Date of birth;</p>

        <p>Profile photograph;</p>

        <p>Account preferences and settings; and</p>
        ...
        <p>Where required for safety, fraud prevention, legal compliance, or regulatory purposes, SheGo may collect and
            ...
            selfies for identity verification, or other documents required to confirm your identity.</p>

        <p>Identity verification information is processed only for legitimate business or legal purposes and retained in
        ...
        <p>Drivers and service partners may be required to provide additional documentation to enable onboarding and
            ...
            continued use of the Platform. Such information may include:</p>

        <p>Government-issued identity documents;</p>
        ...
        <p>Commercial permits or licences;</p>

        <p>Vehicle fitness certificates;</p>

        <p>Police verification certificates, where required;</p>

        <p>Tax registration details, where applicable;</p>
        ...
        <p>GST details, where applicable; and</p>

        <p>Other information necessary to process payments.</p>
        ...
        <p>Where you choose to use safety features available on the Platform, you may provide the name, relationship,
            ...
            and contact information of one or more emergency contacts.</p>
        ...
        <p>Details of your inquiry or complaint;</p>

        <p>Ride or transaction information relevant to your request;</p>

        <p>Audio recordings of customer support calls, where permitted by law;</p>

        <p>Emails, chat messages, and other communications; and</p>

        <p>Any documents, photographs, or other information you voluntarily provide to assist in resolving your request.

        </p>

        <p>This information is used to investigate issues, improve customer support, enhance service quality, ensure
        ...
        <p>Device model and manufacturer;</p>
        ...
        <p>Battery status (where necessary for service functionality); and</p>
        ...
        <p>We automatically collect your Internet Protocol (IP) address and related network information to help secure
            ...
            our Platform, detect fraudulent activity, troubleshoot technical issues, and comply with applicable legal
        ...
        <p>When you access the Platform through a web browser or mobile application, we may collect browser type,
            ...
            browser version, unique device identifiers, advertising identifiers (where permitted), operating system
        ...
        <p>Ride searches and bookings;</p>

        <p>Feature usage;</p>

        <p>Pages or screens visited;</p>

        <p>Search history within the Platform;</p>

        <p>Session duration; and</p>
        ...
        <p>Our website and certain features of the Platform may use cookies, web beacons, pixels, software development
            ...
            kits (SDKs), and similar technologies to recognize users, remember preferences, improve functionality,

            analyze traffic, personalize content, and enhance security.</p>

        <p>You may manage certain cookie preferences through your browser settings, although disabling cookies may
        ...
        <p>We may use analytics tools and technologies to understand how users interact with the Platform, measure
            ...
            performance, identify trends, evaluate user engagement, and improve the quality of our Services.</p>

        <p>Analytics information is generally used in aggregated or de-identified form wherever reasonably practicable.
        ...
        <p>We may collect information relating to your internet connection or mobile network, including network type,
            ...
            carrier information, signal strength, connection quality, and related technical information necessary to
        ...
        <p>Contact access is optional and will only be used for the purposes disclosed at the time permission is
        ...
        <p>You may opt out of promotional communications at any time while continuing to receive essential
        ...
        <p>Personal information, ride information, communications, location information, and other relevant records may
            ...
            be reviewed to investigate accidents, complaints, safety incidents, fraud, policy violations, or suspected
        ...
        <p>Background location will only be collected where necessary for specific Platform functionality and after
        ...
        <p>Process ride requests;</p>

        <p>Match Riders with nearby Drivers;</p>

        <p>Provide navigation and estimated arrival times;</p>

        <p>Monitor active trips;</p>

        <p>Improve safety features;</p>

        <p>Detect fraudulent activity;</p>

        <p>Investigate incidents; and</p>
        ...
        <p>Location collection generally begins when a user requests or accepts a ride, opens location-dependent
            ...
            features, or otherwise grants location permission for the relevant functionality. Collection generally ends

            when the ride is completed, the relevant feature is closed, location permission is revoked, or the

            application no longer requires location access, except where retention or limited continued processing is

            necessary to comply with applicable law, resolve disputes, detect fraud, or support legitimate business
        ...
        <p>When you request a ride, SheGo shares limited information with the assigned Driver that is necessary to
            ...
            privacy-protecting communication methods where available), ride preferences, and any information required
        ...
        <p>We may share payment-related information with authorized payment gateways, banks, financial institutions, and
            ...
            payment processing partners to facilitate payments, refunds, incentives, fraud detection, and transaction

            verification. Payment providers process such information in accordance with their own privacy policies and
        ...
        <p>We may share limited information with analytics providers to understand Platform usage, evaluate performance,
            ...
            improve user experience, measure engagement, and enhance our Services. Wherever reasonably practicable,
        ...
        <p>To provide efficient customer support, we may share relevant information with authorized customer support
            ...
            service providers, communication platforms, or technical support vendors who assist us in responding to user
        ...
        <p>Respond to lawful requests from public authorities;</p>
        ...
        <p>We may share personal information with our parent company, subsidiaries, affiliates, or group companies for
            ...
            internal administrative purposes, operational support, compliance, security, analytics, and service
        ...
        <p>Where personal information is transferred outside India, SheGo will implement appropriate safeguards in
            ...
            organizational security measures, confidentiality obligations, encryption, access controls, and any

            additional measures required under applicable data protection legislation to ensure an appropriate level of
        ...
        <p>Ride records, trip details, and related operational information may be retained to support customer service,
            ...
            safety investigations, dispute resolution, fraud prevention, accounting, legal compliance, and service
        ...
        <p>You may request the deletion of your personal information where such deletion is permitted under applicable
            ...
            law and does not conflict with our legal, regulatory, contractual, fraud prevention, or legitimate business
        ...
        <p>Where processing is based on your consent, you may withdraw that consent at any time. Withdrawal of consent
            ...
            will not affect the lawfulness of processing carried out before the withdrawal and may affect the
        ...
        <p>Essential Cookies: Required for the operation, security, and functionality of the Platform.</p>

        <p>Performance Cookies: Used to measure Platform performance and identify technical issues.</p>

        <p>Analytics Cookies: Used to understand user interactions, traffic patterns, and feature usage.</p>

        <p>Preference Cookies: Used to remember user preferences and personalize certain Platform features.</p>

        <p>Advertising Cookies (Where Applicable): Used to deliver relevant promotional content and measure the

            effectiveness of marketing campaigns.</p>

        <p>Our mobile application may also use Software Development Kits (SDKs), pixels, local storage, and similar
        ...
        <p>Maintain secure sessions;</p>

        <p>Remember user preferences;</p>

        <p>Improve Platform functionality;</p>

        <p>Analyze traffic and usage trends;</p>

        <p>Detect fraud and unauthorized activity;</p>

        <p>Measure service performance; and</p>
        ...
        <p>Most web browsers allow users to manage or disable cookies through browser settings. Users may also manage
            ...
            certain tracking permissions through their device settings.</p>

        <p>Please note that disabling certain cookies or tracking technologies may affect the availability or
        ...
        <p>Where permitted by applicable law, SheGo may send users promotional messages relating to new features,
            ...
            email, SMS, push notifications, or other communication channels.</p>

        <p>We will only send such communications in accordance with your communication preferences and applicable legal
        ...
        <p>Using the unsubscribe option included in marketing emails;</p>

        <p>Updating your communication preferences within your account settings, where available;</p>
        ...
        <p>The Platform is intended for individuals who are legally eligible to use the Services under applicable law.
            ...
            Users who have not attained the minimum legal age may use the Platform only with the involvement and consent
        ...
        <p>Where required by applicable law, we will notify users of material changes through appropriate means,
        ...
        <p>The revised Privacy Policy becomes effective on the date specified at the beginning of the updated version
            ...
            unless otherwise stated. Continued use of the Platform after the effective date constitutes your
        ...
        <p>Privacy-related complaints;</p>

        <p>Requests concerning personal information;</p>

        <p>Data correction or deletion requests;</p>

        <p>Consent withdrawal requests;</p>

        <p>Security concerns; and</p>
        ...
        <p>This Privacy Policy shall be governed by and construed in accordance with the laws of India, including the
            ...
            Digital Personal Data Protection Act, 2023, the Information Technology Act, 2000, and other applicable laws
        ...
        <p>Subject to applicable law, any dispute arising out of or relating to this Privacy Policy, the processing of
            ...
            personal information, or the use of the Platform shall be subject to the exclusive jurisdiction of the
        ...
        <p>Our safety features may include:</p>

        <p>Live trip tracking;</p>

        <p>Ride sharing with trusted contacts;</p>

        <p>Emergency (SOS) assistance;</p>

        <p>Emergency contact notifications;</p>

        <p>Driver identity verification;</p>

        <p>In-app safety support; and</p>
        ...
        <p>Verification may include, where permitted by applicable law:</p>

        <p>Identity verification;</p>

        <p>Driving licence validation;</p>

        <p>Vehicle registration verification;</p>

        <p>Vehicle insurance verification;</p>

        <p>Commercial permit verification;</p>

        <p>Criminal or police verification where legally permitted;</p>

        <p>Background screening conducted by authorized verification partners; and</p>

        <p>Periodic re-verification during a Driver&#x27;s continued use of the Platform.</p>

        <p>Verification does not constitute a guarantee of future conduct, and users should continue to exercise
        ...
        <p>Identity verification may involve:</p>

        <p>Government-issued identification documents;</p>

        <p>Selfie or facial verification;</p>

        <p>Mobile number verification through one-time passwords (OTPs);</p>

        <p>Email verification; and</p>

        <p>Other verification procedures reasonably necessary to prevent fraud, enhance Platform security, and comply

            with legal obligations.</p>

        <p>Verification information is processed only for legitimate purposes and retained in accordance with this
        ...
        <p>Any recordings may be collected or processed solely for purposes including:</p>
        ...
        <p>Resolution of disputes; and</p>

        <p>Compliance with applicable law.</p>

        <p>Access to recordings will be restricted to authorized personnel and retained only for the period necessary to
        ...
        <p>Login monitoring;</p>

        <p>Transaction monitoring;</p>

        <p>Location anomaly detection;</p>

        <p>Duplicate account detection;</p>

        <p>Payment fraud detection;</p>

        <p>Suspicious activity analysis; and</p>
        ...
        <p>These technologies may assist with:</p>

        <p>Ride matching;</p>

        <p>Route optimization;</p>

        <p>Estimated arrival times;</p>
        ...
        <p>Customer support automation; and</p>
        ...
        <p>Notifications may include information regarding:</p>

        <p>The nature of the incident;</p>

        <p>Categories of information involved;</p>

        <p>Steps taken to contain the incident;</p>

        <p>Measures users may take to protect themselves; and</p>
        ...
        <p>We strive to ensure that personal data is:</p>

        <p>Processed lawfully and fairly;</p>

        <p>Collected only for specified and lawful purposes;</p>

        <p>Limited to what is necessary for those purposes;</p>

        <p>Protected through appropriate technical and organizational safeguards;</p>

        <p>Retained only for as long as necessary; and</p>
        ...
        <p>Withdrawal of consent does not affect processing carried out before such withdrawal and may limit the
        ...
        <p>Process the deletion request within a reasonable period;</p>

        <p>Delete or anonymize personal information that is no longer required; and</p>

        <p>Retain only information that must be preserved to comply with legal, regulatory, tax, accounting, fraud

            prevention, dispute resolution, or contractual obligations.</p>

        <p>Deletion of an account does not automatically require immediate deletion of all information where continued
        ...
        <p>We continually seek to improve accessibility through inclusive design, user-friendly interfaces, and features

            that support individuals with varying needs.</p>

        <p>Where accessibility features require the processing of personal information, such information will be handled

            in accordance with this Privacy Policy and applicable data protection laws. Accessibility-related

            information will be collected only where necessary to provide or improve such features and will not be used

            for unrelated purposes without an appropriate legal basis.</p>
            ...
            <section className="safety-section">
                <div className="safety-container">
                    ...
                    <div className="safety-heading">
                        ...
                        <a href="#" className="safety-book-btn">
                            Book Ride
                        </a>
                    </div>
